...
of historical states and the current state. The history will be stored in flattened format as that
...
```q
q)finalState:repeat+(1000000000-count[res 1])mod period
q)finalState
468
```
